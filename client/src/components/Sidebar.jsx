...
function Sidebar({ isOpen }) {
  ...
  // If sidebar is closed, return a mini sidebar version
  if (!isOpen) {
    return (
      <div className="w-[5%]  mr-10 h-[calc(100vh-6.625rem)] fixed left-0 overflow-y-auto hover:overflow-y-scroll bg-white">
        <div className="flex flex-col items-center py-4 space-y-4">
          <div className="flex flex-col items-center hover:bg-gray-300 duration-300 rounded-xl p-2 cursor-pointer">
          ...
          <div className="flex flex-col items-center hover:bg-gray-300 duration-300 rounded-xl p-2 cursor-pointer">
            <PiUserSquareThin className="text-xl" />
  ...
  // Full sidebar (original code with minor adjustments)
  return (
